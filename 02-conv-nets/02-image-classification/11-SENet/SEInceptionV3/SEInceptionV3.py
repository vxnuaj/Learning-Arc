...
SEBlocks are only after inception modules in this implementation
...
class SEInceptionV3(nn.Module):
    ...
    reduct_ratio: the reduction ratio of channels for a given SE Block
    ...
    def __init__(self, reduct_ratio):
        ...
        self.head = nn.Sequential(
            ...
            Conv2dBN(in_channels = 3, out_channels = 32, kernel_size = 3, stride = 2),
            Conv2dBN(in_channels = 32, out_channels = 32, kernel_size = 3), 
            Conv2dBN(in_channels = 32, out_channels = 64, kernel_size = 3, padding = 1), 
            nn.MaxPool2d(kernel_size = 3, stride = 2), 
            Conv2dBN(in_channels = 64, out_channels = 80, kernel_size = 1), 
            Conv2dBN(in_channels = 80, out_channels = 192, kernel_size = 3), 
            nn.MaxPool2d(kernel_size = 3, stride = 2) 
        ...
        self.body1 = nn.Sequential(
            ...
            SEBlock(channels = 256, reduct_ratio = reduct_ratio ),
            InceptionBlockA(in_channels = 256, out_1 = 64, out_2 = (48, 64), out_3 = (64, 96, 96), out_4 = 64), 
            SEBlock( channels = 288, reduct_ratio = reduct_ratio),
        ...
        self.body2 = nn.Sequential(
            ...
            InceptionBlockB(in_channels = 288, out_1 = 384, out_2 = (64, 64, 96)), # grid size reduction
            SEBlock( channels = 768, reduct_ratio = reduct_ratio)
        ...
        self.body4 = nn.Sequential(
            ...
            InceptionBlockD(in_channels = 768, out_1 = (192, 320), out_2 = (192, 192, 192, 192)), # grid size reduction -> 1, 1280, 8, 8
            SEBlock( channels = 1280, reduct_ratio = reduct_ratio)
        )
      
        self.body5 = nn.Sequential(
            
            InceptionBlockE(in_channels = 1280, out_1 = 320, out_2 = (384, 384, 384), out_3 = (448, 384, 384, 384), out_4 = (192)),
            SEBlock( channels = 2048, reduct_ratio = reduct_ratio),
    ...
    def forward(self, x):
        ...
        aux_x = self.aux(x) # auxiliary classifier for better backpropagation
